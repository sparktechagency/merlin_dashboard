    ...
    <div className="rounded-2xl overflow-hidden ">
      ...
      <div className="flex flex-col items-center justify-center  bg-white p-8">
        <div className="flex flex-col items-center text-center max-w-md w-full space-y-10">
          ...
          <h2 className="text-[22px] font-semibold text-[#EF4444]">You are going to delete this admin</h2>
          <p className="text-[16px] text-gray-700 leading-relaxed">
            After deleting, [admin name] won&apos;t be able to <br /> upload photos of their city.
          </p>
