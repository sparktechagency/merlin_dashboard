        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="w-full bg-[#636363]/0.5 max-w-lg py-20">
                <CardHeader className="space-y-2 text-center pb-4">
                    ...
                    <p className="text-lg text-gray-600 max-w-xs mx-auto font-normal">Create a new password. Ensure it differs from
                        previous ones for security</p>
                </CardHeader>
                <CardContent>
                    <Form className="space-y-4" from={from} onSubmit={handleSubmit}>
                        <FromInput
                            className="bg-[#636363]/0.5 border h-12"
                            eye={true}
                        ...
                        <div className="flex justify-center">
                            <Button variant={"main"} className="cursor-pointer rounded-sm bg-primary text-[#ffff]">Update Password</Button>
                        </div>
                    </Form>
                </CardContent>
            </Card>
